...
public class Po010ServiceImpl extends EgovAbstractServiceImpl implements Po010Service {
	...
	public String selectOrm010ListJson(int poo010id, String pocotype) throws Exception {
	    ...
	    for(Ismodm010VO vo : listIsmodm010VO){
	    	...
	    	jsonObject.put("ststusNm",          URLEncoder.encode(vo.getStstusNm(), "UTF-8"));
	    	...
	    	jsonObject.put("claimstatusnm",     URLEncoder.encode(vo.getClaimstatusnm(), "UTF-8"));
	    	jsonObject.put("claimreasonnm",     URLEncoder.encode(vo.getClaimreasonnm(), "UTF-8"));
	    	jsonObject.put("retstatusnm",       URLEncoder.encode(vo.getRetstatusnm(), "UTF-8"));
