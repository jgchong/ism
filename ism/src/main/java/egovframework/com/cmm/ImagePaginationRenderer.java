...
public class ImagePaginationRenderer extends AbstractPaginationRenderer implements ServletContextAware{
	...
	public void initVariables(){
        ...
        */
		firstPageLabel    = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">&lt;&lt;</a>";
		previousPageLabel = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">&lt;</a><span>";
		currentPageLabel  = "<a href=\"#\" class=\"on\">{0}</a>";
		otherPageLabel    = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">{2}</a>";
		nextPageLabel     = "</span><a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">&gt;</a>";
		lastPageLabel     = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">&gt;&gt;</a>";
	}
