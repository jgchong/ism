...
*/
		...
		//프로젝트 홈페이지로 이동
		return "forward:/ism/main/mainPage.do";
	}
    ...
    public String selectMainMenuLeft(
    	...
    	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser(); //jgc add
    	if(EgovUserDetailsHelper.isAuthenticated()){
    		...
    		model.addAttribute("userOneSelect", userManageVO);
    		//jgc add [e]
    	}
