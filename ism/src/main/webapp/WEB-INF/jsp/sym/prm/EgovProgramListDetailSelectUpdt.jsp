...
<div class="wrap">
	...
	<div class="container">
		...
		<div class="contentsWrap"> <!-- 추가 div -->
            ...
            <!-- 현재위치 네비게이션 시작 -->
            <div class="contents">
                <p class="layerTit">프로그램목록 상세조회 /수정</p>
                <form:form commandName="progrmManageVO" action="/sym/prm/EgovProgramListDetailSelectUpdt.do">
                    ...
                    <!-- 버튼 [s] -->   
					<p class="layerFootBt">
						<a href="<c:url value='/sym/mpm/EgovProgramListManageSelect.do'/>" class="cancel" onclick="selectList(); return false;">목록</a>
						<a href="#LINK" class="confirm" onclick="javascript:updateProgramListManage(document.getElementById('progrmManageVO')); return false;"><spring:message code="button.save" /></a>
						<a href="<c:url value='/sym/prm/EgovProgramListManageDelete.do'/>?progrmFileNm=<c:out value="${progrmManageVO.progrmFileNm  }"/>" class="confirm" onclick="deleteProgramListManage(document.getElementById('progrmManageVO')); return false;"><spring:message code="button.delete" /></a>
					</p>
                    <!-- 버튼 [e] -->
