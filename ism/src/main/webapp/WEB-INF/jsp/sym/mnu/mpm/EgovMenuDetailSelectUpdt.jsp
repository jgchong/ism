		...
		<div class="contentsWrap"> <!-- 추가 div -->
            ...
            <div class="contents">
                ...
                <form:form commandName="menuManageVO" name="menuManageVO" action ="<c:url value='/sym/mnu/mpm/EgovMenuDetailSelectUpdt.do' />" method="post">
                    ...
                    <!-- 버튼 [s] -->   
					<p class="layerFootBt">
						<a href="<c:url value='/sym/mnu/mpm/EgovMenuManageSelect.do'/>" class="cancel" onclick="selectList(); return false;">목록</a>
						<a href="#LINK" class="confirm" onclick="javascript:updateMenuManage(document.getElementById('menuManageVO')); return false;"><spring:message code="button.save" /></a>
						<a href="#LINK" class="confirm" onclick="deleteMenuManage(document.getElementById('menuManageVO')); return false;"><spring:message code="button.delete" /></a>
					</p>
                    <!-- 버튼 [e] -->
