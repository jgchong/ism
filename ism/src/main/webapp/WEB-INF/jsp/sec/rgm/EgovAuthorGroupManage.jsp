...
<div class="wrap">
    ...
    <div class="container">
        <!-- 좌측메뉴 시작 -->
        <div class="lnb"><c:import url="/sym/mms/EgovMainMenuLeft.do" /></div>
        <!-- //좌측메뉴 끝 -->
            <!-- 현재위치 네비게이션 시작 -->
            <div  class="contentsWrap">
                <!-- 검색 필드 박스 시작 -->
                <div class="contents">
					<h2 class="pageTit">사용자별 권한관리</h2>
                    <form:form class="searchArea" name="listForm" action="<c:url value='/sec/rgm/EgovAuthorGroupList.do'/>" method="post">  
                        ...
                        <input name="searchKeyword" type="text" value="<c:out value='${authorGroupVO.searchKeyword}'/>" size="25" title="검색" onkeypress="press();" class="it"/>
                        <a href="#LINK" onclick="javascript:fncSelectAuthorGroupPop()" style="vertical-align:middle;">팝업</a>
                        
                        <a href="#LINK" onclick="javascript:fncSelectAuthorGroupList('1')" style="vertical-align:middle;">조회</a>
                        
                        <a href="#LINK" onclick="javascript:fncAddAuthorGroupInsert()" style="vertical-align:middle;">권한등록</a>
                        
                        <a href="#LINK" onclick="javascript:fncAuthorGroupDeleteList()" style="vertical-align:middle;">등록취소</a>
