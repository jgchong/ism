            ...
            <div class="contents">
				...
				<form:form commandName="cmmnDetailCode" name="cmmnDetailCode" method="post">
					...
					<p class="layerFootBt">
						...
						<a href="#noscript" class="confirm" onclick="fn_egov_regist_CmmnDetailCode(document.cmmnDetailCode); return false;">저장</a>
					</p>
                    <!-- 버튼 [e] -->
                    <!-- 검색조건 유지 -->
                    <!-- 검색조건 유지 -->
